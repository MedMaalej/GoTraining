...
<form name="frm" action="ListeTable" method="post"> 
<table border="0">
    <tr>
...
if($listpri != NULL)
{
foreach($listpri as $valeur)
{
    if(($valeur!="parametreliste")&&($valeur!="table_liste")&&($valeur!="prametrechamp")&&($valeur!="liste"))
    {
?>

    <option value="<?php echo $valeur['TABLE_NAME']  ?>"  <?php if(@$_POST['tableprimaire']==$valeur['TABLE_NAME']){ ?> selected="selected" <?php }?>>  <?php echo $valeur['TABLE_NAME']  ?> </option>
